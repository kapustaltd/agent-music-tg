...
- [x] Отключить автоматический `requestFullscreen()` при инициализации Mini App.
...
- [x] Переключить дефолты CheapVibeCode на `deepseek-v4-flash` и RU endpoint.
- [x] Нормализовать старый endpoint override и ограничить зависший LLM-вызов 45 секундами.
- [x] Добавить focused-тесты для нормализации endpoint и постоянных ошибок провайдера.
